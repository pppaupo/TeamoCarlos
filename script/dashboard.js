...
const mensajes = [
    ...
    "Nosotros éramos amantes incluso antes de nacer en este mundo.💖",
    "La soledad es dolorosa; lo entiendo tan bien ahora. Si tú no estás, es como estar solo. 🌹",
    "Gracias por hacerme tan feliz. 😊",
    "Eres lo mejor que me ha pasado. ☀️",
    "Si sigo con vida es gracias a tu corazón. Incluso ahora, tu corazón late en el mío.💓",
];
